...
class SystemSettingService:
    ...
    @staticmethod
    async def get_setting(setting_id: str) -> SystemSetting | None:
        """
        获取配置详情（含属性值）
    ...
    @staticmethod
    async def get_setting_by_code(tenant_id: str, code: str) -> SystemSetting | None:
        """
        按编号获取配置
    ...
    @staticmethod
    async def delete_setting(setting_id: str) -> bool:
        """
        删除配置（级联删除属性值）
