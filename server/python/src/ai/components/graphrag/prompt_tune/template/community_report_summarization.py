...
from ai.components.graphrag.prompt.prompt_tune.template.zh.community_report_summarization import (
    COMMUNITY_REPORT_SUMMARIZATION_PROMPT as ZH_COMMUNITY_REPORT_SUMMARIZATION_PROMPT,
)
...
{{input_text}}
Output:"""
    if ZH_COMMUNITY_REPORT_SUMMARIZATION_PROMPT is None
    else ZH_COMMUNITY_REPORT_SUMMARIZATION_PROMPT
)
