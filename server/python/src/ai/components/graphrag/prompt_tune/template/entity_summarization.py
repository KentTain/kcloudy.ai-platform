...
from ai.components.graphrag.prompt.prompt_tune.template.zh.entity_summarization import (
    ENTITY_SUMMARIZATION_PROMPT as ZH_ENTITY_SUMMARIZATION_PROMPT,
)
...
#######
Output:"""
    if ZH_ENTITY_SUMMARIZATION_PROMPT is None
    else ZH_ENTITY_SUMMARIZATION_PROMPT
)
