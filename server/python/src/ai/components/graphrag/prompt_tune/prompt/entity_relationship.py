...
from ai.components.graphrag.prompt.prompt_tune.prompt.zh.entity_relationship import (
    ENTITY_RELATIONSHIPS_GENERATION_JSON_PROMPT as ZH_ENTITY_RELATIONSHIPS_GENERATION_JSON_PROMPT,
)
from ai.components.graphrag.prompt.prompt_tune.prompt.zh.entity_relationship import (
    ENTITY_RELATIONSHIPS_GENERATION_PROMPT as ZH_ENTITY_RELATIONSHIPS_GENERATION_PROMPT,
)
from ai.components.graphrag.prompt.prompt_tune.prompt.zh.entity_relationship import (
    UNTYPED_ENTITY_RELATIONSHIPS_GENERATION_PROMPT as ZH_UNTYPED_ENTITY_RELATIONSHIPS_GENERATION_PROMPT,
)

# 实体关系生成提示词模板
# Entity relationships generation prompt template
...
output:
"""
    if ZH_ENTITY_RELATIONSHIPS_GENERATION_PROMPT is None
    else ZH_ENTITY_RELATIONSHIPS_GENERATION_PROMPT
)

# JSON 格式实体关系生成提示词模板
# JSON format entity relationships generation prompt template
...
output:
"""
    if ZH_ENTITY_RELATIONSHIPS_GENERATION_JSON_PROMPT is None
    else ZH_ENTITY_RELATIONSHIPS_GENERATION_JSON_PROMPT
)

# 无类型实体关系生成提示词模板
# Untyped entity relationships generation prompt template
...
Output:
"""
    if ZH_UNTYPED_ENTITY_RELATIONSHIPS_GENERATION_PROMPT is None
    else ZH_UNTYPED_ENTITY_RELATIONSHIPS_GENERATION_PROMPT
)
