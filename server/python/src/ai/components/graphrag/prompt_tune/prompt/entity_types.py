...
from ai.components.graphrag.prompt.prompt_tune.prompt.zh.entity_types import (
    ENTITY_TYPE_GENERATION_JSON_PROMPT as ZH_ENTITY_TYPE_GENERATION_JSON_PROMPT,
)
from ai.components.graphrag.prompt.prompt_tune.prompt.zh.entity_types import (
    ENTITY_TYPE_GENERATION_PROMPT as ZH_ENTITY_TYPE_GENERATION_PROMPT,
)

# 实体类型生成提示词模板
# Entity type generation prompt template
...
{{<entity_types>}}
"""
    if ZH_ENTITY_TYPE_GENERATION_PROMPT is None
    else ZH_ENTITY_TYPE_GENERATION_PROMPT
)

# JSON 格式实体类型生成提示词模板
# JSON format entity type generation prompt template
...
"""
    if ZH_ENTITY_TYPE_GENERATION_JSON_PROMPT is None
    else ZH_ENTITY_TYPE_GENERATION_JSON_PROMPT
)
