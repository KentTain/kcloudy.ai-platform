"""包含 run 和 _compute_leiden_communities 方法定义的模块."""
...
def _compute_leiden_communities(
    ...
    """
    处理compute_leiden_communities。

    Args:
        graph (nx.Graph | nx.DiGraph): graph 参数。
        max_cluster_size (int): max_cluster_size 参数。
        use_lcc (bool): use_lcc 参数。
        seed: seed 参数。
