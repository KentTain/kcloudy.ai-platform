...
export const adminRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "marketplaces/:id/browse",
        name: "AdminMarketplaceBrowse",
        component: () => import("@/tenant/pages/admin/MarketplaceBrowsePage.vue"),
        meta: { title: "浏览市场", hidden: true, requiresAdminAuth: true, permissions: ["tenant:marketplace:read"] },
      },
      {
        path: "marketplaces/:id/plugins",
        redirect: (to) => ({ name: "AdminMarketplaceBrowse", params: { id: to.params.id } }),
      },
      {
