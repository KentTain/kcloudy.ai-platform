...
| pages/ | 页面组件（ChatPage、ConversationListPage） |
| router/ | 模块路由配置 |
...
| 页面 | 路径 | 功能 |
|------|------|------|
| ChatPage | /ai | AI 对话界面，支持流式响应 |
| ConversationListPage | /ai/conversations | 会话历史列表管理 |
...
| /ai/conversations | ConversationListPage | requiresAuth |
