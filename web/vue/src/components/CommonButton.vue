...
type CommonVariant = "primary" | "secondary" | "outline" | "ghost" | "danger";
...
// 业务变体 → shadcn 变体映射
const variantMap: Record<CommonVariant, ButtonVariants["variant"]> = {
  primary: "default",
  secondary: "secondary",
  outline: "outline",
  ghost: "ghost",
...
const sizeMap: Record<CommonSize, ButtonVariants["size"]> = {
  sm: "sm",
  md: "default",
  lg: "lg",
};
...
const variantOverride: Record<CommonVariant, string> = {
  primary: "",
  secondary: "",
