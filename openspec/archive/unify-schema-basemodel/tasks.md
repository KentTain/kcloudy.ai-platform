...
- [x] 1.3 创建检测脚本 `server/python/scripts/check_schema_basemodel.sh`
- [x] 1.4 验证 framework.schemas.BaseModel 的配置符合预期
...
- [x] 7.1 将检测脚本集成到 CI 流程（可选）
- [x] 7.2 更新项目 README.md（如有必要）
- [x] 7.3 创建变更总结并归档
