...
class ModulePermissionService:
    ...
    @staticmethod
    async def list_all_by_module(module_id: str) -> list[ModulePermission]:
        """获取模块的所有权限（不分页）"""
        async with async_session() as session:
            stmt = (
                select(ModulePermission)
    ...
    @staticmethod
    async def get_by_id(permission_id: str) -> ModulePermission | None:
        """根据 ID 获取权限"""
        async with async_session() as session:
    ...
    @staticmethod
    async def get_by_code(code: str) -> ModulePermission | None:
        """根据编码获取权限"""
        async with async_session() as session:
    ...
    @staticmethod
    async def get_by_ids(permission_ids: list[str]) -> list[ModulePermission]:
        """根据 ID 列表获取权限"""
    ...
    @staticmethod
    async def delete(permission_id: str) -> bool:
        """
        删除模块权限
    ...
    @staticmethod
    async def delete_by_module(module_id: str) -> int:
        """
        删除模块的所有权限
