...
from ai.components.graphrag.prompt.prompt_tune.prompt.zh.community_report_rating import (
    GENERATE_REPORT_RATING_PROMPT as ZH_GENERATE_REPORT_RATING_PROMPT,
)

# 社区报告评级生成提示词模板
# Community report rating generation prompt template
...
"""
    if ZH_GENERATE_REPORT_RATING_PROMPT is None
    else ZH_GENERATE_REPORT_RATING_PROMPT
)
