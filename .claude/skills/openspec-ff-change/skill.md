...
5. **检查文档更新需求**
   ...
   在创建 tasks.md 时，检查变更是否涉及：
   - 新的开发命令（如测试、构建、部署）
   - 新的工具或框架
   - 新的项目结构或目录
   - 新的开发流程或工作流

   如果涉及，在 tasks.md 中添加文档更新任务：
   ```markdown
   ## N. Documentation

   - [ ] N.1 Update README.md with new commands/workflow
   - [ ] N.2 Update module CLAUDE.md if backend changes
   - [ ] N.3 Update module CLAUDE.md if frontend changes
   ```
