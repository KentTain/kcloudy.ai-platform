...
- [ ] **步骤 1：创建目录结构**
- [ ] **步骤 2：创建公共 fixtures（tests/ai/conftest.py）**
- [ ] **步骤 3：验证目录结构**
- [ ] **步骤 4：Commit**
...
- [ ] **步骤 1：编写 I18nObject 测试**
- [ ] **步骤 2：运行 I18nObject 测试**
- [ ] **步骤 3：编写 ToolInvokeMessage 测试**
- [ ] **步骤 4：运行完整 entities 测试**
- [ ] **步骤 5：Commit**
...
- [ ] **步骤 1：编写 encrypt_credentials 测试**
- [ ] **步骤 2：编写 decrypt_credentials 测试**
- [ ] **步骤 3：编写 mask_credentials 测试**
- [ ] **步骤 4：编写 validate_credentials_format 测试**
- [ ] **步骤 5：编写 extract_credentials_schema 测试**
- [ ] **步骤 6：运行完整 CredentialService 测试**
- [ ] **步骤 7：Commit**
...
- [ ] **步骤 1：编写 get_plugin_list 测试**
- [ ] **步骤 2：编写 get_plugin_info 测试**
- [ ] **步骤 3：编写凭证管理测试**
- [ ] **步骤 4：运行 PluginManagementService 测试**
- [ ] **步骤 5：Commit**
