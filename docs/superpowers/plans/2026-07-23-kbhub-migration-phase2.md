...
- [x] **步骤 2：在 models/__init__.py 导出**
...
- [x] **步骤 2：在 __init__.py 导出 Folder**
...
- [x] **步骤 2：在 __init__.py 导出 Document/DocumentVersion**
...
- [x] **步骤 3：在 __init__.py 导出**

追加 `Tag`、`TagGroup`、`Persona`。

- [x] **步骤 4：运行模型可映射测试 + Commit**
...
- [x] **步骤 3：创建 ConfigItem 模型（文档库级配置）**
...
- [x] **步骤 8：更新 services/__init__.py 导出全部服务**
...
- [x] **步骤 1：替换 types/index.ts 为真实类型**
